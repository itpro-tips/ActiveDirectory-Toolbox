...
.NOTES
	Former Author		: Alexandre Augagneur (www.alexwinner.com)
...
.EXAMPLE
	.\Find-MissingADSubnets.ps1 -Path C:\Temp -Domain "corpnet.net"
	
.EXAMPLE
	.\Find-MissingADSubnets.ps1 -Path C:\Temp -Server "dc01.corpnet.net","dc02.corpnet.net"

.EXAMPLE
	.\Find-MissingADSubnets.ps1 -Path C:\Temp -IPv4Mask 16 -nbLines 250

.EXAMPLE
	.\Find-MissingADSubnets.ps1 -Path C:\Temp -IPv4Mask 16 -nbLines 250 -CollectOnly
